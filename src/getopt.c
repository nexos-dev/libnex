                            ...
                            int only)
{
    ...
    if (longopt_match < 0 && shortopts != NULL)
    {
        ...
        has_arg = ((cp[1] == ':') ? ((cp[2] == ':') ? OPTIONAL_ARG : required_argument) : no_argument);
...
#ifndef _AIX
int _libnex_getopt (int argc, char** argv, char* optstring)
{
    return getopt_internal (argc, argv, optstring, NULL, NULL, 0);
}
#endif

int _libnex_getopt_long (int argc,
                         char** argv,
...
int _libnex_getopt_long_only (int argc,
                              char** argv,
                              const char* shortopts,
                              const GETOPT_LONG_OPTION_T* longopts,
                              int* longind)
